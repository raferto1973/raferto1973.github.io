const translations = {
    en: {
        ...
        navContact: "Contact",
        heroEyebrow: "Bilingual public-facing project portfolio",
        heroTitle: "Building polished digital products without exposing the private engine room.",
        heroText: "I design and ship web products with a strong focus on usability, responsive frontend execution, and pragmatic full-stack delivery. This portfolio shows what each product does, what I solved, and how it was built, while keeping production repositories private where needed.",
        ...
        experienceTitle: "How I typically contribute",
        experienceAside: "A capability timeline you can keep generic or replace with roles, clients, and years.",
    ...
    es: {
        ...
        navContact: "Contacto",
        heroEyebrow: "Portfolio público bilingüe",
        heroTitle: "Construyendo productos digitales pulidos sin enseñar la sala de máquinas privada.",
        heroText: "Diseño y lanzo productos web con un foco fuerte en usabilidad, ejecución frontend responsive y entrega full-stack pragmática. Este portfolio muestra qué hace cada producto, qué resolví y cómo fue construido, manteniendo privados los repositorios de producción cuando conviene.",
        ...
        experienceTitle: "Cómo suelo aportar en un proyecto",
        experienceAside: "Una línea de capacidades que puedes dejar genérica o sustituir por roles, clientes y años.",
